...
public class D2_Calculator {
	...
	public void paramInt(String s,String cal) {
		...
		this.num1= Integer.parseInt(s.substring(0,s.indexOf(cal)));// s-> "5+10" -> "5"만 추출해서 정수형으로 변환하여 num1에 저장
		this.num2= Integer.parseInt(s.substring(s.indexOf(cal)+1));// s-> "5+10" -> "10"만 추출해서 정수형으로 변환하여 num2에 저장
	}
